      ...
      <div className='max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed'>
            Коммерческая модель AgroHealth AI Digital Twin — создание нового рынка превентивного
              ...
              <div className='grid md:grid-cols-2 gap-8'>
                  ...
                  <div className='space-y-4 text-blue-800'>
                    ...
                    <div className='flex items-start'>
                      ...
                      <div>
                        ...
                        <p>
                          Помогать людям жить дольше и healthier, а банкам создавать точные
                          финансовые продукты
                        </p>
                      </div>
                    </div>
                ...
                <div className='bg-green-50 rounded-2xl p-6'>
                  ...
                  <div className='space-y-3 text-green-800'>
                    ...
                    <div className='text-sm text-green-600 mt-4'>* К 2027 году в Узбекистане</div>
                  </div>
                </div>
              </div>
                ...
                {[
                    ...
                    tiers: [
                      {
                        name: 'Basic',
                        price: '$3/мес',
                        features: ['Мониторинг', 'Базовые предсказания'],
                      },
                      { name: 'Standard', price: '$7/мес', features: ['24h прогнозы', '3D Twin'] },
                      {
                        name: 'Premium',
                        price: '$15/мес',
                        features: ['Генетика', 'Персональный коуч'],
                      },
                    ],
                  },
                  {
                  ...
                  },
                  {
                    ...
                    tiers: [
                      ...
                      {
                        name: 'Insurance',
                        price: '5% revenue share',
                        features: ['Оптимизация премий'],
                      },
                    ],
                  },
                ].map((stream, index) => (
